...
def get_co2_electricity_mix(env_config):
    return dfc.find_value_env_config("co2_eq_el_mix", "value", env_config)


def get_co2_heating_oil(env_config):
    return dfc.find_value_env_config("co2_eq_oil_watt", "value", env_config)
...
def co2_electricity_mix(env_config, electricity):
    ...
    """
    return electricity * get_co2_electricity_mix(env_config)
